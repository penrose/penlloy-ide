...
import { usePathResolver } from "../image-resolution/ImageResolution.js";
import { currentCanvasState, currentDiagramState } from "../state/atoms.js";

export default function VizPanel() {
  const canvasRef = useRef<HTMLDivElement>(null);
  const [diagram, setDiagram] = useRecoilState(currentDiagramState);
  const [, setCanvasState] = useRecoilState(currentCanvasState);
